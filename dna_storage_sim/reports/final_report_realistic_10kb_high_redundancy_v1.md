...
```json
{
  ...
  "output": {
    "out_dir": "results",
    "run_id": "realistic_10kb_high_redundancy_v1",
...
- `results/realistic_10kb_high_redundancy_v1/agg/summary_top_configs.csv`
...
| s1 | 0.0002 | 0.0 | 0.0 | 0.0 | 1.4576512455516013 | 1.09765625 | 10 |
...
| s2 | 0.0002 | 0.0 | 0.0 | 0.0 | 0.8563701067615659 | 1.646484375 | 10 |
...
- `results/realistic_10kb_high_redundancy_v1/agg/chunk_recovery_frontier_summary.csv`
- `results/realistic_10kb_high_redundancy_v1/agg/chunk_recovery_frontier_by_psub.csv`
